...
public final class DateUtil {
     ...
     */
    @SneakyThrows
    public static Date parseDate(String text, DateUtilEnum pattern) {
     ...
     * @return Calendar
     */
    public static Calendar parseCalendar(String text, DateUtilEnum pattern) {
     ...
     * @return Timestamp
     */
    public static Timestamp parseTimestamp(String text, DateUtilEnum pattern) {
        Date d = parseDate(text, pattern);
        if (d == null) {
            return null;
        }
    ...
    public static Date parse(String text) {
        if (StringUtils.isEmpty(text)) {
            return null;
        } else if (text.matches(CommonConstant.REG_DATE_FMT_Y)) {
            return DateUtil.parseDate(text, DateUtilEnum.DATE_FMT_Y);
        } else if (text.matches(CommonConstant.REG_DATE_FMT_Y_M)) {
            return DateUtil.parseDate(text, DateUtilEnum.DATE_FMT_Y_M);
        } else if (text.matches(CommonConstant.REG_DATE_FMT_Y_M_D)) {
            return DateUtil.parseDate(text, DateUtilEnum.DATE_FMT_Y_M_D);
        } else if (text.matches(CommonConstant.REG_DATE_FMT_Y_M_D_H)) {
            return DateUtil.parseDate(text, DateUtilEnum.DATE_FMT_Y_M_D_H);
        } else if (text.matches(CommonConstant.REG_DATE_FMT_Y_M_D_HM)) {
            return DateUtil.parseDate(text, DateUtilEnum.DATE_FMT_Y_M_D_HM);
        } else if (text.matches(CommonConstant.REG_DATE_FMT_Y_M_D_HMS)) {
            return DateUtil.parseDate(text, DateUtilEnum.DATE_FMT_Y_M_D_HMS);
        } else if (text.matches(CommonConstant.REG_DATE_FMT_Y_M_D_HMSSS)) {
