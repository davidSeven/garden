...
/**
 * @author garden
 * @date 2020-04-08 9:00
 */
public class HandlerJsonViewMessageConverter extends MappingJackson2HttpMessageConverter {

    private HandlerJsonViewSerializer serializer = new HandlerJsonViewSerializer();

    public HandlerJsonViewMessageConverter() {
        super();
    ...
    public HandlerJsonViewMessageConverter(ObjectMapper mapper) {
        super();
        SimpleModule module = new SimpleModule();
        module.addSerializer(JsonView.class, this.serializer);
