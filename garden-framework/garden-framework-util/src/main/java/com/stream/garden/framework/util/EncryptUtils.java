...
public class EncryptUtils {
    ...
    public static void main(String[] args) {
        try {
            ...
            int lineLength = 64;
            String publicKey = wordwrap(keyMap.get(0), lineLength);
            String privateKey = wordwrap(keyMap.get(1), lineLength);
            ...
            logger.info("私钥长度:{}", keyMap.get(1).length());
            logger.info("私钥长度:{}", unWordwrap(keyMap.get(1)).length());
