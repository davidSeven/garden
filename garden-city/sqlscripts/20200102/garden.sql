...
-- ----------------------------
-- Table structure for war_material_t
-- ----------------------------
DROP TABLE IF EXISTS `war_material_t`;
CREATE TABLE `war_material_t` (
  `ID` varchar(32) NOT NULL COMMENT 'ID',
  `CODE` varchar(32) DEFAULT '' COMMENT '编码',
  `NAME` varchar(32) DEFAULT '' COMMENT '名称',
  `STATE` varchar(2) DEFAULT '' COMMENT '状态',
...
-- ----------------------------
-- Records of war_material_t
-- ----------------------------

-- ----------------------------
-- Table structure for war_storage_location_t
-- ----------------------------
DROP TABLE IF EXISTS `war_storage_location_t`;
CREATE TABLE `war_storage_location_t` (
  `ID` varchar(32) NOT NULL COMMENT 'ID',
  `CODE` varchar(32) DEFAULT '' COMMENT '编码',
  `NAME` varchar(32) DEFAULT '' COMMENT '名称',
  `STATE` varchar(2) DEFAULT '' COMMENT '状态',
...
-- ----------------------------
-- Records of war_storage_location_t
-- ----------------------------
