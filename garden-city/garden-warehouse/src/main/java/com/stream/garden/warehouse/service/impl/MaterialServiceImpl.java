 ...
 */
@Service
public class MaterialServiceImpl extends AbstractBaseService<Material, String> implements IMaterialService {
    public MaterialServiceImpl(IMaterialDao iMaterialDao) {
        super(iMaterialDao);
    }
}
