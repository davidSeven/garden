...
<script type="text/javascript">
    layui.use(['jquery', 'table', 'layer', 'form'], function () {
        ...
        function initTable(fileManageId) {
            table.render({
                elem: '#tableData'
                ,url:'/file/fileInfo/pageList'
                ,method: 'post'
                ,page: {
                    limit: 20
                    ,limits: [10, 20, 50, 200]
                ...
                ,cols: [[
                    {type:'numbers'}
                    ,{type:'checkbox'}
                    ,{field:'bizCode', width:100, title: '业务编码'}
                    ,{field:'bizId', width:150, title: '业务ID'}
                    ,{field:'originalName', width:150, title: '文件名'}
                    ,{field:'extendName', width:100, title: '扩展名'}
                    ,{field:'size', width:100, title: '文件大小', templet: function (row) {
