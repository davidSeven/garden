 ...
 */
@Service
public class GroupUserService extends AbstractBaseService<GroupUser, String> implements IGroupUserService {

    public GroupUserService(IGroupUserDao iGroupUserDao) {
        super(iGroupUserDao);
    }
}
