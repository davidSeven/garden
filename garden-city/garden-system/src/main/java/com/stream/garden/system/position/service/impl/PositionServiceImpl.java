 ...
 */
@Service
public class PositionServiceImpl extends AbstractBaseService<Position, String> implements IPositionService {
    public PositionServiceImpl(IPositionDao iPositionDao) {
        super(iPositionDao);
    }
}
