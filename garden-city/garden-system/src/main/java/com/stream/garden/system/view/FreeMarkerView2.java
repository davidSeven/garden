...
public class FreeMarkerView2 extends AbstractTemplateView {
	 ...
	 * to created for every single {@link FreeMarkerView2} instance. This can be quite expensive
	...
	protected Template getTemplate(Locale locale) throws IOException {
		...
		// 加载模板
        String templateString = FreeMarkerViewCache.getTemplate(url);
        if (null != templateString) {
            Reader reader = new StringReader(templateString);
            return new Template(url, reader, obtainConfiguration());
        }
	...
	private class DelegatingServletConfig implements ServletConfig {
		...
		public String getServletName() {
			return FreeMarkerView2.this.getBeanName();
		}

		@Override
		@Nullable
		public ServletContext getServletContext() {
			return FreeMarkerView2.this.getServletContext();
		}
