 ...
 * that supports {@link FreeMarkerView2} (i.e. FreeMarker templates) and custom subclasses of it.
 *
 ...
 * @see FreeMarkerView2
 */
public class FreeMarkerViewResolver2 extends AbstractTemplateViewResolver implements Ordered {

	/**
	 * Sets the default {@link #setViewClass view class} to {@link #requiredViewClass}:
	 * by default {@link FreeMarkerView2}.
	 */
	public FreeMarkerViewResolver2() {
	 ...
	 * @since 4.3
	 */
	public FreeMarkerViewResolver2(String prefix, String suffix) {
		this();
		setPrefix(prefix);
		setSuffix(suffix);
	}
	...
	/**
	 * Requires {@link FreeMarkerView2}.
	 */
	@Override
	protected Class<?> requiredViewClass() {
		return FreeMarkerView2.class;
	}
