            ...
            <div class="layui-form-item">
                <div class="layui-inline tool-btn" style="margin-right: 0;">
                    <button id="addBtn" class="layui-btn layui-btn-small layui-btn-primary hidden-xs has-permission"
                            data-url="/system/organization/toEdit"><i class="layui-icon">&#xe654;</i></button>
                    ...
                    <button id="deleteBtn" class="layui-btn layui-btn-small layui-btn-primary hidden-xs has-permission"
                            data-url="/system/organization/delete"><i class="layui-icon layui-icon-delete"></i></button>
...
<script type="text/javascript">
    layui.use(['jquery', 'layer', 'form'], function () {
        ...
        $("#addBtn").click(function () {
            ...
            parent.page("编辑", url, iframeObj, w = "700px", h = "500px", {isInsert: true, nodes: nodes});
            return false;
        });
        ...
        $("#editBtn").click(function () {
            ...
            if (nodes.length === 1) {
                var url = $(this).attr('data-url');
                //将iframeObj传递给父级窗口,执行操作完成刷新
                parent.page("编辑", url, iframeObj, w = "700px", h = "500px", {isInsert: false, nodes: nodes});
            } else {
