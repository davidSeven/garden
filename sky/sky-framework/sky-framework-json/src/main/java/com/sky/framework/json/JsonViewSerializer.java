...
import static com.sky.framework.json.MatcherBehavior.CLASS_FIRST;
import static com.sky.framework.json.MatcherBehavior.PATH_FIRST;
...
public class JsonViewSerializer extends JsonSerializer<JsonView> {
    ...
    class JsonWriter {
        ...
        void writeObject(Object obj) throws IOException {
                ...
                try {
                    ...
                    if (fieldAllowed(property, obj.getClass())) {
                        ...
                        if (null != fieldExpandInterface) {
                            boolean skip = fieldExpandInterface.filter(currentPath, name, val, jgen);
                            if (skip) {
                                continue;
                            }
                        }
            ...
            // 扩展
            if (null != fieldExpandInterface) {
                fieldExpandInterface.append(jgen);
            }
