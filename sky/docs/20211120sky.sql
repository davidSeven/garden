...
CREATE TABLE `acc_account`  (
  ...
  `state` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '状态，激活：ACTIVATE，冻结：FREEZE，停用：DEACTIVATE',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '账户信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for acc_account_balance
-- ----------------------------
...
CREATE TABLE `acc_account_balance`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '账户余额信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `acc_account_statement`  (
  ...
  `invoice_line_no` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '单据行号',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `acc_account_statement_idx1`(`customer_code`, `currency`, `invoice_no`) USING BTREE COMMENT '客户编码，币种，单据号'
...
CREATE TABLE `inv_inventory`  (
  ...
  `batch_no` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '批次号',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `inv_inventory_idx1`(`customer_code`, `warehouse_code`, `product_code`, `batch_no`) USING BTREE COMMENT '客户编号，仓库编号，产品编号，批次号'
) ENGINE = InnoDB AUTO_INCREMENT = 91 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '库存信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `inv_inventory_occupation`  (
  ...
  `batch_no` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '批次号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '库存占用信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `inv_inventory_statement`  (
  ...
  `warehouse_code` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '仓库编码',
  `product_code` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '产品编码',
  `quantity` decimal(16, 4) NULL DEFAULT 0.0000 COMMENT '数量，IN正数，OUT负数',
  `warehouse_date` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '入库日期',
  `invoice_type` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '单据类型',
  `invoice_no` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '单据号',
  `invoice_line_no` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '单据行号',
  `batch_no` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '批次号',
  `operate_type` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '操作类型，IN，OUT',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `inv_inventory_statement_idx1`(`customer_code`, `warehouse_code`, `product_code`, `batch_no`, `invoice_no`) USING BTREE COMMENT '客户编号，仓库编号，产品编号，批次号，单据号'
) ENGINE = InnoDB AUTO_INCREMENT = 90001 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '库存流水信息' ROW_FORMAT = Dynamic;
